...
cim = pd.read_csv(f"{wd}/provinces_final/data/R/block_splsda_temp_genomes_Pathway_KO_Environment_keepX{keepX}_ncomp_2_cim.csv", index_col=0)
plotIndiv = pd.read_csv(f"{wd}/provinces_final/data/R/block_splsda_temp_genomes_Pathway_KO_Environment_keepX{keepX}_ncomp_2_plotIndiv.csv", index_col=0)
plotVar = pd.read_csv(f"{wd}/provinces_final/data/R/block_splsda_temp_genomes_Pathway_KO_Environment_keepX{keepX}_ncomp_2_plotVar.csv", index_col=0)
...
plotIndiv["group"] = plotIndiv["group"].str.replace("UPWL", "CTEM").str.replace("SSTC", "SANT")
