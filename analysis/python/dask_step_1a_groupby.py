...
"""
Dask code for mass processing of counts tables (taxonomy).
"""
...
def start_cluster(cores, memory, jobs, _print=True):
    ...
    """
    slurm_log_output = (
        "/data/gpfs/projects/punim1989/biogo-hub/data/slurm-logs/%x_%A_%a.out"
    )
...
def main(args):
    ...
    tax = dd.read_csv(
        args.taxonomy, sep="\t", dtype={"genome": "object", "genome_name": "object"}
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-m", "--memory", type=str, default="64GB", help="Amount of memory per job."
    )
    parser.add_argument(
        "-j", "--jobs", type=int, default=12, help="Number of jobs to start."
    )
    parser.add_argument(
        "-i",
        "--input",
        type=str,
        default="/data/scratch/projects/punim1293/vini/data/bio-go-data/coverm/*.coverm",
    ...
    parser.add_argument(
        ...
        "--taxonomy",
        type=str,
        default="/data/gpfs/projects/punim1989/databases/genes/genome_reps_filtered_w_genome.txt",
    ...
    parser.add_argument(
        ...
        "--outdir",
        type=str,
        default="/data/scratch/projects/punim1293/vini/data/bio-go-data/dask-tables/tax/bysample/",
