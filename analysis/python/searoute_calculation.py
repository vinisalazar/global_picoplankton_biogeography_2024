...
def calculate_searoute_pairwise_distances(smd):
    ...
    D.to_csv(
        "/data/gpfs/projects/punim1989/biogo-hub/provinces_final/data/distances/searoute_dist_2132_km.csv"
    )
    D_norm.to_csv(
        "/data/gpfs/projects/punim1989/biogo-hub/provinces_final/data/distances/searoute_dist_2132_norm.csv"
    )
...
if __name__ == "__main__":
    smd = pd.read_csv(
        "/data/gpfs/projects/punim1989/biogo-hub/provinces_final/data/metadata.csv"
    )
